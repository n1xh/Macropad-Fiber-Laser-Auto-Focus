  ...
  for (int i = 1; i <= 12; i++) {
    if (!digitalRead(i)) { // switch pressed!
      ...
      while (!digitalRead(5)) {
        ...
        display.println("*         UP        *");
        display.display();
        Keyboard.press(KEY_UP_ARROW);  // press and hold Shift
       // Keyboard.press();          // press and hold F2
      ...
      while (!digitalRead(7)) {
        ...
        display.display();
        Keyboard.press(KEY_LEFT_ARROW);  // press and hold Shift
       // Keyboard.press();          // press and hold F2
        Keyboard.releaseAll();           // release both
        while (!digitalRead(7)) {
       //   autoFocusHold();
      ...
      while (!digitalRead(8)) {
        ...
        display.println("*        DOWN       *");
        display.display();
        Keyboard.press(KEY_DOWN_ARROW);  // press and hold Shift
      //  Keyboard.press();          // press and hold F2
        Keyboard.releaseAll();           // release both
        while (!digitalRead(8)) {
        }
      ...
      while (!digitalRead(9)) {
        ...
        display.display();
        Keyboard.press(KEY_RIGHT_ARROW);  // press and hold Shift
       // Keyboard.press('');          // press and hold F2
        Keyboard.releaseAll();           // release both
        while (!digitalRead(9)) {
        }
...
void DisplayKeys() {
  ...
  display.print("DOWN");
  k++;
  display.setCursor(59, 32 + ((k - 1) / 3) * 8);
  display.print("UP");
  k++;
